...
Then select the CREATE CLUSTER button ![Create cluster button](Activiti/activiti-7-developers-guide/assets/create-GKE-cluster-button.png) from  the top menu. 
